export const en = {
  ...
  auth: {
    continueTitle: "Continue to Việt tại Hàn",
    continueDescription:
      "Use Facebook, Kakao, or Zalo. Existing connections sign you in; new identities start profile setup.",
    continueHint:
  ...
  onboarding: {
    eyebrow: "First setup",
    title: "Set up your VTH profile",
    description:
      "Choose the name, username, and language you will use on Việt tại Hàn.",
    name: "Display name",
    username: "Username",
    usernameHint: "3–24 letters, numbers, or underscores",
    language: "Preferred language",
    start: "Start using Việt tại Hàn",
    saving: "Saving…",
  ...
  post: {
    ...
    cancel: "Cancel",
    removed: "This post was removed by moderators",
    stats: "Post stats",
    share: "Share",
    copyLink: "Copy link",
  ...
  settings: {
    ...
    connectedAccountsDesc:
      "Connect Facebook, Kakao, and Zalo explicitly. Matching email addresses are never linked automatically.",
    connected: "Connected",
  ...
  admin: {
    ...
    reviewQueueDescription: "Review reports from posts, comments, marketplace, and chat.",
    pending: "Pending",
    all: "All",
